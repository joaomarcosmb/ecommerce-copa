...
function Alert({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className={cn("shrink-0 flex items-center justify-center", iconColorVariants[variantKey])}>
...
function AlertTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-[14px] leading-5 font-['Poppins',sans-serif] font-medium mb-1 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:opacity-80",
        className,
      )}
      {...props}
    />
